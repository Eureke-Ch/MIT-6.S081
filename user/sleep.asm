...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 458:	39cc8c93          	addi	s9,s9,924 # 7f0 <malloc+0x10e>
 ...
 466:	3e6b8b93          	addi	s7,s7,998 # 848 <digits>
 ...
 58c:	26098993          	addi	s3,s3,608 # 7e8 <malloc+0x106>
        while(*s != 0){
 590:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 66e:	1f67b783          	ld	a5,502(a5) # 860 <freep>
 ...
 696:	00e6ea63          	bltu	a3,a4,6aa <free+0x4a>
{
 ...
 6d8:	18f73623          	sd	a5,396(a4) # 860 <freep>
}
 6dc:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 70a:	15a53503          	ld	a0,346(a0) # 860 <freep>
 ...
 732:	13290913          	addi	s2,s2,306 # 860 <freep>
  if(p == (char*)-1)
 736:	5afd                	li	s5,-1
 738:	a895                	j	7ac <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 73a:	00000797          	auipc	a5,0x0
 73e:	12e78793          	addi	a5,a5,302 # 868 <base>
 742:	00000717          	auipc	a4,0x0
 746:	10f73f23          	sd	a5,286(a4) # 860 <freep>
 74a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 76e:	0ea73b23          	sd	a0,246(a4) # 860 <freep>
      return (void*)(p + 1);
