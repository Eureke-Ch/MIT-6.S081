...
int main(int argc, char *argv[]){
  ...
  14:	88058593          	addi	a1,a1,-1920 # 890 <malloc+0xec>
  18:	4509                	li	a0,2
  1a:	00000097          	auipc	ra,0x0
  1e:	6a4080e7          	jalr	1700(ra) # 6be <fprintf>
    exit(1);
  22:	4505                	li	a0,1
  24:	00000097          	auipc	ra,0x0
  28:	34e080e7          	jalr	846(ra) # 372 <exit>
  }
  int p[2];
  pipe(p);
  2c:	fd840513          	addi	a0,s0,-40
  30:	00000097          	auipc	ra,0x0
  34:	352080e7          	jalr	850(ra) # 382 <pipe>
  char buf[10];

  if(fork() != 0){
  38:	00000097          	auipc	ra,0x0
  3c:	332080e7          	jalr	818(ra) # 36a <fork>
  40:	cd31                	beqz	a0,9c <main+0x9c>
    // buf = "ping";
    write(p[1], "ping", 4);
  42:	4611                	li	a2,4
  44:	00001597          	auipc	a1,0x1
  48:	85c58593          	addi	a1,a1,-1956 # 8a0 <malloc+0xfc>
  4c:	fdc42503          	lw	a0,-36(s0)
  50:	00000097          	auipc	ra,0x0
  54:	342080e7          	jalr	834(ra) # 392 <write>
    wait(0);
  58:	4501                	li	a0,0
  5a:	00000097          	auipc	ra,0x0
  5e:	320080e7          	jalr	800(ra) # 37a <wait>
    read(p[0], buf, 4);
  62:	4611                	li	a2,4
  64:	fc840593          	addi	a1,s0,-56
  68:	fd842503          	lw	a0,-40(s0)
  6c:	00000097          	auipc	ra,0x0
  70:	31e080e7          	jalr	798(ra) # 38a <read>
    int pid_p = getpid();
  74:	00000097          	auipc	ra,0x0
  78:	37e080e7          	jalr	894(ra) # 3f2 <getpid>
  7c:	85aa                	mv	a1,a0
    printf("%d: received %s\n", pid_p, buf);
  7e:	fc840613          	addi	a2,s0,-56
  82:	00001517          	auipc	a0,0x1
  86:	82650513          	addi	a0,a0,-2010 # 8a8 <malloc+0x104>
  8a:	00000097          	auipc	ra,0x0
  8e:	662080e7          	jalr	1634(ra) # 6ec <printf>
    exit(0);
  92:	4501                	li	a0,0
  94:	00000097          	auipc	ra,0x0
  98:	2de080e7          	jalr	734(ra) # 372 <exit>
  }else{
    int pid_c = getpid();
  9c:	00000097          	auipc	ra,0x0
  a0:	356080e7          	jalr	854(ra) # 3f2 <getpid>
  a4:	84aa                	mv	s1,a0
    read(p[0], buf, 10);
  a6:	4629                	li	a2,10
  ...
  b4:	2da080e7          	jalr	730(ra) # 38a <read>
    close(p[0]);
  b8:	fd842503          	lw	a0,-40(s0)
  bc:	00000097          	auipc	ra,0x0
  c0:	2de080e7          	jalr	734(ra) # 39a <close>
    printf("%d: received %s\n", pid_c,buf);
  c4:	fc840613          	addi	a2,s0,-56
  c8:	85a6                	mv	a1,s1
  ca:	00000517          	auipc	a0,0x0
  ce:	7de50513          	addi	a0,a0,2014 # 8a8 <malloc+0x104>
  d2:	00000097          	auipc	ra,0x0
  d6:	61a080e7          	jalr	1562(ra) # 6ec <printf>
    write(p[1], "pong", 4);
  da:	4611                	li	a2,4
  dc:	00000597          	auipc	a1,0x0
  e0:	7e458593          	addi	a1,a1,2020 # 8c0 <malloc+0x11c>
  e4:	fdc42503          	lw	a0,-36(s0)
  e8:	00000097          	auipc	ra,0x0
  ec:	2aa080e7          	jalr	682(ra) # 392 <write>
    close(p[1]);
  f0:	fdc42503          	lw	a0,-36(s0)
  f4:	00000097          	auipc	ra,0x0
  f8:	2a6080e7          	jalr	678(ra) # 39a <close>
    exit(0);
  fc:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51a:	3bac8c93          	addi	s9,s9,954 # 8d0 <malloc+0x12c>
 ...
 528:	404b8b93          	addi	s7,s7,1028 # 928 <digits>
 ...
 64e:	27e98993          	addi	s3,s3,638 # 8c8 <malloc+0x124>
        while(*s != 0){
 652:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 730:	2147b783          	ld	a5,532(a5) # 940 <freep>
 ...
 758:	00e6ea63          	bltu	a3,a4,76c <free+0x4a>
{
 ...
 79a:	1af73523          	sd	a5,426(a4) # 940 <freep>
}
 79e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7cc:	17853503          	ld	a0,376(a0) # 940 <freep>
 ...
 7f4:	15090913          	addi	s2,s2,336 # 940 <freep>
  if(p == (char*)-1)
 7f8:	5afd                	li	s5,-1
 7fa:	a895                	j	86e <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7fc:	00000797          	auipc	a5,0x0
 800:	14c78793          	addi	a5,a5,332 # 948 <base>
 804:	00000717          	auipc	a4,0x0
 808:	12f73e23          	sd	a5,316(a4) # 940 <freep>
 80c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
